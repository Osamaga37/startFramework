...
export default function Contact() {
  return (
    <div className=' p-10 flex justify-center items-center flex-col'>
      ...
      <Header title="Contact section" bgColor="#374151"/>
      </div>
      

<form class=" w-2/4 mt-10">
<div class="relative z-0 w-full mb-10 group">
  ...
  <button type="submit" class="text-white bg-teal-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send Message</button>
</form>
